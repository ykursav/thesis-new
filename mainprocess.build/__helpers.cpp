...
MOD_INIT_DECL( bitarray );
MOD_INIT_DECL( bitarray$test_bitarray );
MOD_INIT_DECL( extractionv4 );
MOD_INIT_DECL( matching );
MOD_INIT_DECL( nose );
MOD_INIT_DECL( nose$case );
...
MOD_INIT_DECL( nose$plugins$base );
MOD_INIT_DECL( nose$plugins$builtin );
MOD_INIT_DECL( nose$plugins$deprecated );
MOD_INIT_DECL( nose$plugins$doctests );
MOD_INIT_DECL( nose$plugins$errorclass );
MOD_INIT_DECL( nose$plugins$manager );
MOD_INIT_DECL( nose$plugins$plugintest );
MOD_INIT_DECL( nose$plugins$skip );
MOD_INIT_DECL( nose$proxy );
MOD_INIT_DECL( nose$pyversion );
MOD_INIT_DECL( nose$result );
MOD_INIT_DECL( nose$selector );
MOD_INIT_DECL( nose$suite );
MOD_INIT_DECL( nose$tools );
MOD_INIT_DECL( nose$tools$nontrivial );
MOD_INIT_DECL( nose$tools$trivial );
MOD_INIT_DECL( nose$util );
MOD_INIT_DECL( numpy );
...
MOD_INIT_DECL( numpy$distutils$lib2def );
...
{
    { (char *)"bitarray", MOD_INIT_NAME( bitarray ), NUITKA_COMPILED_PACKAGE },
    { (char *)"bitarray.test_bitarray", MOD_INIT_NAME( bitarray$test_bitarray ), NUITKA_COMPILED_MODULE },
    { (char *)"extractionv4", MOD_INIT_NAME( extractionv4 ), NUITKA_COMPILED_MODULE },
    { (char *)"matching", MOD_INIT_NAME( matching ), NUITKA_COMPILED_MODULE },
    { (char *)"nose", MOD_INIT_NAME( nose ), NUITKA_COMPILED_PACKAGE },
    { (char *)"nose.case", MOD_INIT_NAME( nose$case ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.config", MOD_INIT_NAME( nose$config ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.core", MOD_INIT_NAME( nose$core ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.exc", MOD_INIT_NAME( nose$exc ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.ext", MOD_INIT_NAME( nose$ext ), NUITKA_COMPILED_PACKAGE },
    { (char *)"nose.ext.dtcompat", MOD_INIT_NAME( nose$ext$dtcompat ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.failure", MOD_INIT_NAME( nose$failure ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.importer", MOD_INIT_NAME( nose$importer ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.loader", MOD_INIT_NAME( nose$loader ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.plugins", MOD_INIT_NAME( nose$plugins ), NUITKA_COMPILED_PACKAGE },
    { (char *)"nose.plugins.base", MOD_INIT_NAME( nose$plugins$base ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.plugins.builtin", MOD_INIT_NAME( nose$plugins$builtin ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.plugins.deprecated", MOD_INIT_NAME( nose$plugins$deprecated ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.plugins.doctests", MOD_INIT_NAME( nose$plugins$doctests ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.plugins.errorclass", MOD_INIT_NAME( nose$plugins$errorclass ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.plugins.manager", MOD_INIT_NAME( nose$plugins$manager ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.plugins.plugintest", MOD_INIT_NAME( nose$plugins$plugintest ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.plugins.skip", MOD_INIT_NAME( nose$plugins$skip ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.proxy", MOD_INIT_NAME( nose$proxy ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.pyversion", MOD_INIT_NAME( nose$pyversion ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.result", MOD_INIT_NAME( nose$result ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.selector", MOD_INIT_NAME( nose$selector ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.suite", MOD_INIT_NAME( nose$suite ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.tools", MOD_INIT_NAME( nose$tools ), NUITKA_COMPILED_PACKAGE },
    { (char *)"nose.tools.nontrivial", MOD_INIT_NAME( nose$tools$nontrivial ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.tools.trivial", MOD_INIT_NAME( nose$tools$trivial ), NUITKA_COMPILED_MODULE },
    { (char *)"nose.util", MOD_INIT_NAME( nose$util ), NUITKA_COMPILED_MODULE },
    ...
    { (char *)"numpy.distutils.lib2def", MOD_INIT_NAME( numpy$distutils$lib2def ), NUITKA_COMPILED_MODULE },
    ...
    { (char *)"numpy.lib._version", MOD_INIT_NAME( numpy$lib$_version ), NUITKA_COMPILED_MODULE },
    ...
    { (char *)"numpy.polynomial._polybase", MOD_INIT_NAME( numpy$polynomial$_polybase ), NUITKA_COMPILED_MODULE },
    ...
    { (char *)"preprocessing", MOD_INIT_NAME( preprocessing ), NUITKA_COMPILED_MODULE },
    ...
    { (char *)"scipy._lib", MOD_INIT_NAME( scipy$_lib ), NUITKA_COMPILED_PACKAGE },
    { (char *)"scipy._lib._version", MOD_INIT_NAME( scipy$_lib$_version ), NUITKA_COMPILED_MODULE },
    { (char *)"scipy._lib.six", MOD_INIT_NAME( scipy$_lib$six ), NUITKA_COMPILED_MODULE },
