...
out2 = VideoWriter("ADAPTIVE_THRESHOLD_TESTS/cropped02.avi", fourcc, 5.0, (128, 128))
#@profile
...
if __name__ == "__main__": 
    cap = VideoCapture("ADAPTIVE_THRESHOLD_TESTS/signature_video00.avi")
    f = open("signature_test00.bin", "wb")
    counter = 0
    signature_counter = 0
    sig_first = bitarray()
    sig_second = bitarray()
