                    ...
                    for key in image_effect:
                         ...
                         for key in meter_modes:
                              ...
                              for key in drc_strengths:
                                   ...
                                   cv2.imwrite("cam_test/output_test_" + str(counter) + "_" + exposure_modes[key] + "_" +  awb_modes[key] + \
                                        "_" + flash_modes[key]  + "_" +  image_effect[key]  + "_" +  meter_modes[key]  + "_" +  drc_strengths[key], frame)
